...
## Steps to reproduce tidy data sets

1. Open the R script run_analysis.R using a text editor.
2. Change the parameter of the setwd function call to the working directory/folder ("folder" is where the R script file is saved).
